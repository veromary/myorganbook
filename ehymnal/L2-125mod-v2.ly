...
soprano = \relative c' { 
  ...
  \partial 4 d4 ^\markup { \hspace #-4 \italic "To be sung in unison."}  | a'2 g4 | f( e) d | a'2 b4 | c2 \bar "||" a4 | d2 c4 | bes4( a) g | a( g4.) f8 | f2 \bar "||" \break
...
\markup {
	\column {
	    ...
	    \line { \small { \hspace #42 \small "Ad cenam Agni providi." }}
}} 
