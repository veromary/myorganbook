...
\header {
  dedication = \markup {  \center-align { "SAINTS' DAYS: ST. JOHN BAPTIST"
	\hspace #0.1 }}	
...
\markup { \hspace #8 \small {  \column { \line {\smallCaps  "Office Hymn."   " E." \hspace #38 \italic "Paulus Diaconus, 8th cent.  Tr. R. E. R." }   
					 \line { \hspace #36 "Ut queant laxis." }
                                         \line { "                    "}
}}}
...
\markup { \hspace #26 %%add space as necc. to center the column
          \column { %% super column of everything
				  ...
				  \column  { \raise #0.0 "ET thine example, holy John, remind us,"
