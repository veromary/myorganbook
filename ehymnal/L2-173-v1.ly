...
\markup { \small { \hspace #74 \italic "J. G. Whittie, 1807-92." }}
...
\markup {\column {
	\line { \hspace #15 \italic "For a Dedication Festival, or for a Special Service of Dedication, the following"}
	...
	\line { "       " } %%% blank line
		...
		"537  Rejoice today with one accord."
