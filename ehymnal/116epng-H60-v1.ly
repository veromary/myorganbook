%%%116e.png
%%%Hymn 60 modern tune. Illsley. Most holy Lord and God of heaven
%%%Version 1
...
\header {
  ...
  title = \markup { "60 " \large \smallCaps "(Modern Tune)" }
...
\markup {
	\column {
	    \line { \small { \hspace #4 \smallCaps "Office Hymn." \hspace #60 \italic {"4th or 5th cent.  Tr. M. F. B."} } }  
	    \line { \small { \hspace #6 \italic "Wednesday Evening." \hspace #16 "Caeli Deus sanctissime."} }
} }
...
\markup { \hspace #4   %%add space as necc. to center the column
		...
		\column { %% column 1
	        \hspace #1 % adds vertical spacing between verses
				  ...
				  \column  { \raise #0.0 "OST holy Lord and God of heaven," "  Who to the glowing sky hast given" } }          
