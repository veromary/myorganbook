...
\header {
  dedication = \markup {  \center-align { "SAINTS' DAYS: ALL SAINTS" 
	\hspace #0.1 }}	
...
\markup { \hspace #8 \small {  \column { \line {\smallCaps  "Office Hymn."   " E." \italic "and" " M." \hspace #46 \italic "9th cent.   Tr. T. A. L." }   
					 \line { \hspace #32 "Jesu, Salvator saeculi." }
                                         \line { "                    "}
}}}
...
\markup { \hspace #30 %%add space as necc. to center the column
          \column { %% super column of everything
				  ...
				  \column  { \raise #0.0 " SAVIOUR Jesu, not alone"
...
\markup { \hspace #30 %%add space as necc. to center the column
          \column { %% super column of everything				 	 
			 ...
			 \line { "3  "
			\column {	 
				"For souls in guilt ensnarèd pray"
