%%%112a.png
%%%Hymn 54 Wareham. Ye clouds and darkness
%%%Version 1
...
\header {
  ...
  title = \markup { "54 " \large \smallCaps "(Modern Tune)" }
...
\markup {
	\column {
	    ...
	    \line { \small { \hspace #5 \italic "Wednesday Morning." \hspace #16 "Nox et tenebrae et nubila."} }
} }
...
\markup { \hspace #2   %%add space as necc. to center the entire block of lyrics
		...
		\column { %% column 1
				  ...
				  \column  { \raise #0.0 " E clouds and darkness, hosts of night,"
