%%%% 272a.png
%%%% Hymn 169 Modern Tune  Blessèd City, heavenly Salem
%%%% Rev 1
...
\header {
  ...
  title = \markup { "169 " \large \smallCaps "(Modern Tune)" }   
...
bass = \relative c {\clef bass 
  ...
  a2( b4) d | e( b e) fis | \straddle g( b, d e8[ d] | c4 b) d2 | g2. \bar "||" }
}
...
\markup { \hspace #12 \small {  \column { \line {\smallCaps  "Office Hymn."  "E." \italic "and" "M."  \hspace #30 \italic "c. 7th cent.  Tr. J. M. Neale" "‡." }    
					 \line { \hspace #30 "Urbs beata Jerusalem." }
}}}
...
\markup { \hspace #32 %%add space as necc. to center the column
          \column { %% super column of everything
				  ...
				  \column  { \raise #0.0 "LESSÈD City, heavenly Salem,"
