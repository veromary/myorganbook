...
\header {
  ...
  arranger =  \markup { \small {\center-align {
			    ...
			    \line { "‘" \hspace #-1 \italic "Gesangbuch" \hspace #-1.2 ",’" \italic "1566."  }
  	}}}
...
%%% For some reson, line spacing (the height of blank lines) is not always the same. \lower has been used every now and then
%%% to obtain the correct line spacings.
...
\markup { \lower #0.4 { \hspace #30 \italic "See also:" \hspace #1 \column { "624  Hail thee, Festival Day."
...
\markup {  \lower #1.4 { \hspace #52 \center-align { 	
