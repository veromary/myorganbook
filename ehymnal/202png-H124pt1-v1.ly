%%% 202.png
%%% Hymn 124 Part 1 His cheering message from the grave
%%% Version 1
...
\header {
  dedication = \markup { \center-align {  "THE CHRISTIAN YEAR - EASTERTIDE"
		\hspace #0.1 }}	
		title = \markup { "124" \large \smallCaps "(Part I)" }
...
\markup {
	\column {
	    \line { \small { \hspace #4 \smallCaps  "Office Hymn" "(" \hspace #-1 \italic "in full" \hspace #-1 ")." \italic " Low Sunday"  } }  
	    \line { \small { \hspace #14 \italic "till Ascension," "M."      \hspace #46 \italic "4th or 5th cent.  Tr. T. A. L." }}                                    
	     \line { \hspace #42 \small "Sermone blando Angelus." }
	} 
} 
...
%%% Main lyric block
%%% To fit on one page, lyrics are in 3 columns: column 1 (verses ), column 2 (a dividing line), column 3 (verses); centered last verse
...
\markup { \hspace #6  %%add space as necc. to center the entire block of lyrics
		...
		\column { %% column 1
				  ...
				  \column  { \raise #0.0 "IS cheering message from the grave"
