...
soprano = \relative c' {
  \pad f2^\markup {\italic "To be sung in unison."} g4 | a2 f4 | g2 e4 | f2. \bar "||" c'2 c4 | d2 a4 | \break
  c2 c4 | a2. \bar "||" a2 g4 \bar "||" bes2 a4 | g2 f4 | a2. \bar "||" \break
  a2 bes4 | a2 f4 | g2 e4 | f2. \bar "||" f2 g4 | a2( g4) | f2. \bar "||"
}
...
bass = \relative c { \clef bass
  f2 s4 | s2. | s2. | f2. \bar "||" a,2 f'4 \bar "||" d2 f4 |
  c2 c4 | f2. \bar "||" f2 s4 | s2. | s2 d4 | a2. \bar "||"
...
\markup { \hspace #78 \small { \center-align { \line { \italic "Michael Weisse, c. 1480-1534." }  
...
%%% If you use another Fraktur font, simply put the name into the font-name override below.
 ...
 \markup { \small { \hspace #42 \override #'(font-name . "HumboldtFraktur") {"Chriſ" \hspace #-1.35 "tus" "iſ" \hspace #-1.35 "t" "erſ" \hspace #-1.35 "tanben." }}}
