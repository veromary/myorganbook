%%% 116.png
%%% Hymn 58  O Boundless Wisdom, God most high
%%% Version 1
...
% heading section
   \line { \lower #0.5 \small { \hspace #-27 \smallCaps "Office Hymn." \hspace #60 \italic "c. 6th cent.  Tr. G. G." } } 
   \line { \small { \hspace #-25 \italic "Monday Evening." \hspace #18 "Immense caeli Conditor."} }
...
% Create a line made up of two columns of verse separated by a vertical line
   \line {
         ...
         \column { \line { \hspace #2 "   " \column { "Renew the fount of life within,"
                                                      "And quench the wasting fires of sin." } }

                   \hspace #1 
           	   \line { \hspace #2 "4  " \column { "Let faith discern the eternal Light"
