%%% 116b.png
%%% Hymn 59  "Earth's mighty Maker, whose command"
%%% Version 2
...
% heading section
   \line { \lower #0.5 \small { \hspace #-27 \smallCaps "Office Hymn." \hspace #55 \italic "c. 7th cent.  Tr. Anon. (1854)." } } 
   \line { \small { \hspace #-25 \italic "Tuesday Evening." \hspace #21 "Telluris ingens Conditor."} }
...
% Create a line made up of two columns of verse separated by a vertical line
   \line {
         ...
         \column { \line { \hspace #2 "   " \column { "That grief may cleanse each deed of ill,"
                                          "And o'er each lust may triumph still." } }

                   \hspace #1 
           	   \line { \hspace #2 "4  " \column { "Let every soul thy law obey,"
