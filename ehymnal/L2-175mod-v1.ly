...
alto = \relative c' {  
  ...
  <d f>2 f4 \bar "dashed" e \push <d f>1 \bar "dashed" <e g>2. \bar "||" <f a>4 <f a> <e g> \bar "dashed" <f bes> <e g> <d f ~> <c f> \bar "dashed"
  
  <bes ~ d ~>1 <bes d ~>2 <a d> \bar "||" d4 c d8[ e] \bar "dashed" f2. d4 \bar "dashed" \push d1 <c e>4. <a c>8 \bar "dashed" <a c>2. \bar "||"
}
...
bass = \relative c {\clef bass 
  f4 d c \bar "dashed" f,2. d'4 \bar "dashed" s1 s4. d8 \bar "dashed" d2. \bar "||"
