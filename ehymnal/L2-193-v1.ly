%%%% 311a.png
%%%% Hymn 193 St. Ambrose.  The praises of that Saint we sing.
%%%% Rev 1.

\version "2.10"

\header {
  dedication = \markup {  \center-align { "SAINTS' DAYS: GENERAL - FOR A MATRON"
	\hspace #0.1 }}	
...
\markup { \hspace #53 \center-align { 
		...
		\line { "              " }
		\line { \smallCaps "Note" \hspace #-1.2 ".—" \hspace #-1 \italic "Hymns" "193" \italic "and" "194" \italic "may also be sung to" \smallCaps "Alfreton" "(" \hspace #-1 \italic "No." "81)" \italic "or to any suitable" }
...
\markup { \small { \hspace #60 \italic "Silvio Antoniano, b. 1540.  Tr. A. R." }}

\markup {  \small {\hspace #43 "Fortem, virili pectore." }}
...
\markup { \hspace #30 %%add space as necc. to center the column
          \column { %% super column of everything
				  ...
				  \column  { \raise #0.0 "HE praises of that Saint we sing,"
