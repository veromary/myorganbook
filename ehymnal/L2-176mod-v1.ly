%%%% 279.png
%%%% Hymn 285. Auctoritate Saeculi.  Let the round world with songs rejoice.
%%%% Rev 1.
...
alto = \relative c' {  
s4 \bar "|" s2 <c f>4 \bar "|" <c ees>2 <aes c>4 \bar "|" <c ees> <aes des> <aes c> \bar "|" <aes c>2 \bar "||" <aes c>4 <c f>2 <ees g>4 \bar "|" <ees aes>2 <ees aes>4 \bar "|" f2 <ees g>4 \bar "|" <ees aes>2 \bar "||"
<des f>4 \bar "|" <ees aes>2 <ees g>4 \bar "|" <ees g>2 <c f>4 \bar "|" <des f>2 ees4 \bar "|" <aes, des>2 \bar "||" c4 \bar "|" <aes des>2 <c ees>4 \bar "|" <bes ees>2 <aes c>4 \bar "|" <c ees> <aes des> <aes c> \bar "|" <aes c>2 \bar "||"
}
