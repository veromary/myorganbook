...
soprano = \relative c' {
  \tag #'vOne { d8 ees f aes bes aes g f \bar "|" c' bes g bes aes g f \bar "||" \break }
...
%%%pp2
  ...
  c8 des \ln ees4 des8 \bar "|" des des \brevenote ees\breve *1/4 ~ \ln ees4 ~ \ln ees4 c8 \bar "||" \break
...
%%%pp2
  ...
  f bes, \lnb c4 des8 \bar "|" des! bes c bes \ln aes4. g8 \lnb c4 f,8 \bar "||" \break
...
lyricsOne = \lyricmode {
  ...
  \once \override LyricText #'self-alignment-X = #0.4
  "7  Yea," Christ my hope is a -- ri -- sen: To Ga -- li -- lee he
  goes be -- fore you.’ 
