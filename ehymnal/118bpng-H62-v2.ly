%%% 118b.png
%%% Hymn 62  "Maker of man, who from thy throne"
%%% Version 2
...
% heading section
   \line { \lower #0.5 \small { \hspace #-30 \smallCaps "Office Hymn." \hspace #54 \italic "c. 7th cent.  Tr. J. D. Chambers" \normal-text "‡." } } 
   \line { \small { \hspace #-28 \italic "Friday Evening." \hspace #22 "Plasmator hominis, Deus." } }
...
% Create a line made up of two columns of verse separated by a vertical line
   \line {
         ...
         \column { \line { \hspace #2 "   " \column { "Hath been with open action blent,"
                                                      "Or mingled with the heart's intent." } }


                   \hspace #1 
           	   \line { \hspace #2 "4  " \column { "In heaven thine endless joys bestow,"
...
\markup { \hspace #22 \small { "(" \italic { Until Candlemas the Doxology of No. 36 may be used for Nos. 50 - 62. } \normal-text ")" } }
